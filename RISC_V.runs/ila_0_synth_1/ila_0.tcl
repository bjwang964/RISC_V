...
set cached_ip [config_ip_cache -export -no_bom  -dir C:/Users/q1109/OneDrive/RISC_V/RISC_V.runs/ila_0_synth_1 -new_name ila_0 -ip [get_ips ila_0]]
...
if { [catch {
  file copy -force C:/Users/q1109/OneDrive/RISC_V/RISC_V.runs/ila_0_synth_1/ila_0.dcp C:/Users/q1109/OneDrive/RISC_V/RISC_V.srcs/sources_1/ip/ila_0/ila_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub C:/Users/q1109/OneDrive/RISC_V/RISC_V.srcs/sources_1/ip/ila_0/ila_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub C:/Users/q1109/OneDrive/RISC_V/RISC_V.srcs/sources_1/ip/ila_0/ila_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim C:/Users/q1109/OneDrive/RISC_V/RISC_V.srcs/sources_1/ip/ila_0/ila_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim C:/Users/q1109/OneDrive/RISC_V/RISC_V.srcs/sources_1/ip/ila_0/ila_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force C:/Users/q1109/OneDrive/RISC_V/RISC_V.runs/ila_0_synth_1/ila_0_stub.v C:/Users/q1109/OneDrive/RISC_V/RISC_V.srcs/sources_1/ip/ila_0/ila_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/Users/q1109/OneDrive/RISC_V/RISC_V.runs/ila_0_synth_1/ila_0_stub.vhdl C:/Users/q1109/OneDrive/RISC_V/RISC_V.srcs/sources_1/ip/ila_0/ila_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/Users/q1109/OneDrive/RISC_V/RISC_V.runs/ila_0_synth_1/ila_0_sim_netlist.v C:/Users/q1109/OneDrive/RISC_V/RISC_V.srcs/sources_1/ip/ila_0/ila_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/Users/q1109/OneDrive/RISC_V/RISC_V.runs/ila_0_synth_1/ila_0_sim_netlist.vhdl C:/Users/q1109/OneDrive/RISC_V/RISC_V.srcs/sources_1/ip/ila_0/ila_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir C:/Users/q1109/OneDrive/RISC_V/RISC_V.ip_user_files/ip/ila_0]} {
  catch { 
    file copy -force C:/Users/q1109/OneDrive/RISC_V/RISC_V.srcs/sources_1/ip/ila_0/ila_0_stub.v C:/Users/q1109/OneDrive/RISC_V/RISC_V.ip_user_files/ip/ila_0
  }
}

if {[file isdir C:/Users/q1109/OneDrive/RISC_V/RISC_V.ip_user_files/ip/ila_0]} {
  catch { 
    file copy -force C:/Users/q1109/OneDrive/RISC_V/RISC_V.srcs/sources_1/ip/ila_0/ila_0_stub.vhdl C:/Users/q1109/OneDrive/RISC_V/RISC_V.ip_user_files/ip/ila_0
  }
}
