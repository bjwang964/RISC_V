...
HD_PWD='C:/Users/q1109/OneDrive/RISC_V/RISC_V.runs/RAM32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RAM32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RAM32.tcl
