...
HD_PWD='C:/Users/q1109/OneDrive/RISC_V/RISC_V.runs/ROM_8_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ROM_8.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ROM_8.tcl
